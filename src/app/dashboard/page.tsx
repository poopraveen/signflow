  ...
  return (
    <div className="mx-auto w-full max-w-6xl flex-1 px-4 py-10">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link
          href="/envelope/new"
          className="inline-flex justify-center rounded-full bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-500"
        >
          New envelope
        </Link>
      </div>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                {(e.status === "sent" || e.status === "completed") &&
                  (e.signers.length === 1 ? (
                    ...
                    <span
                      className="inline-flex items-center rounded-lg border border-amber-200 bg-amber-50 px-3 py-1.5 text-xs font-medium text-amber-900 dark:border-amber-900/50 dark:bg-amber-950/40 dark:text-amber-100"
